/* global NProgress, Morris, tinycolor, ResponsiveBootstrapToolkit */
            ...
            function e() {
                ...
                var s = $.plot(a, series, {
                    grid: {
                        ...
                        markings: function (e) {
                            for (var o = [], t = e.xaxis, r = Math.floor(t.min); r < t.max; r += 2 * t.tickSize)
                                o.push({
                                    xaxis: {
                                        from: r,
                                        to: r + t.tickSize
